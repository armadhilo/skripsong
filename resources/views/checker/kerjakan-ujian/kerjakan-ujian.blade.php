...
<script>
   $(document).ready(function() {
      ...
      var page_url = "{{ Request::segment(3) }}";
   ...
   function jawab(answer){
      $.ajax({
         url: '/checker/kerjakan-ujian/kerjakan_soal/jawab',
         type: "POST",
         data: {data : answer},
         dataType: 'JSON',
   ...
   function finish(id){
         ...
         text: "Apa anda yakin dengan jawaban anda?",
         icon: "warning",
         buttons: true,
         dangerMode: true,
         })
         .then((willDelete) => {
               if (willDelete) {
                     $.ajax({
                        url: '/checker/kerjakan-ujian/kerjakan_soal/finish',
                        type: "POST",
                        data: {data : id},
                        dataType: 'JSON',
                        success: function( data, textStatus, jQxhr ){
